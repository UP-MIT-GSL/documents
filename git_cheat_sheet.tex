...
\item{\texttt{merge}}
     \subitem{Combines your current branch with the branch to be merged with. This command is intelligent for it will automatically combine the two if they have no conflicts, e.g. in branch 1 line 256 of file A was changed, while in branch 2 line 512 of file A was changed. If there is a conflict, it will show which files and lines it occurred.}
