...
\item{\texttt{touch}} 
     \subitem{Make an empty file. If file exists, updates last modified date useful to trigger watchers like guard.}
     \subitem{Useful options: \texttt{-r} (recursive)}
...
\item{\texttt{curl}}  
     ...
     \subitem{Usage:}
       \subsubitem{\texttt{curl www.google.com};\texttt{ curl localhost:8000}}
...
\item{\texttt{apt-get}} 
     ...
     \subitem{Usage: \texttt{sudo apt-get install vim}}
