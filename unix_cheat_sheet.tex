...
\item{\texttt{chmod}} 
     ...
     \subitem{Use the command as follows: \texttt{chmod [A][B][C]}, where \texttt{[A]} is one of \texttt{ugo}, \texttt{[B]} is one of \texttt{+-}, and \texttt{[C]} is one of \texttt{rwx}.}
     \subitem{There are other ways to use the command (see \texttt{man chmod}), but these ones are the most useful.}
